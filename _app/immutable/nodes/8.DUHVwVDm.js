import{t as n,a as r,b as c}from"../chunks/legacy.kROiCmhR.js";import{f,n as i,s as a,c as I,r as q}from"../chunks/utils.CrDVYUnt.js";import{C as S,T as u,a as D}from"../chunks/TwoColsContainer.zeqId5Fh.js";import{C as $}from"../chunks/CodeBlock.DIESrt7C.js";import{T as p}from"../chunks/Title.BHUhat24.js";import{P as v}from"../chunks/Paragraph.CYSbAqwQ.js";import{L as F}from"../chunks/LinksList.Cw5MOKHz.js";const R=""+new URL("../assets/tree.DtdLHkRP.svg",import.meta.url).href;var A=c('<!> <img width="100%" alt="Tree graph">',1),B=c('<div slot="aside"><!></div>'),O=c("<!> <!>",1),E=c("<!> <!>",1),G=c("<!> <!>",1),H=c("<!> <!> <!> <!> <!> <!> <!> <!>",1);function V(x){S(x,{children:(L,N)=>{var _=H(),b=f(_);p(b,{level:"1",children:(t,o)=>{i();var e=n('Three versions of Leetcode "Same tree"');r(t,e)},$$slots:{default:!0}});var g=a(b,2);u(g,{children:(t,o)=>{var e=A(),s=f(e);v(s,{children:(h,m)=>{i();var d=n(`Given the roots of two binary trees p and q, write a function to check if they are the same
